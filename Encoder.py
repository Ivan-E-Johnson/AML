...
class LitAutoEncoder(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        inputs, inputs_2, gt_input = batch['image'], batch['contrastive_patched'], batch['reference_patched']
        ...
        cl_loss = self.contrastive_loss(outputs_v1.flatten(start_dim=1), outputs_v2.flatten(start_dim=1))
...
def do_main():
    ...
    model = LitAutoEncoder(img_size=(240, 240, 16), patch_size=(16, 16, 16), in_channels=1)
