...
from botimageai.dicom_processing.process_one_dicom_study_to_volumes_mapping import ProstatIDDicomStudyToVolumesMapping
from dcm_classifier.utility_functions import itk_read_from_dicomfn_list

if __name__ == "__main__":
    prostatX_data = Path("/Users/iejohnson/School/spring_2024/AML/Supervised_learning/ProstateX/ProstateX_DICOM/manifest-A3Y4AE4o5818678569166032044/PROSTATEx")
    prostatX_segmentation_data = Path("/Users/iejohnson/School/spring_2024/AML/Supervised_learning/ProstateX/ProstateX_DICOM/manifest-1605042674814/PROSTATEx")
    default_output_dir = Path("/Users/iejohnson/School/spring_2024/AML/Supervised_learning/DATA/ALL_PROSTATEx/WITHOUT_SEGMENTATION")
    with_segmentation_output_dir = Path("/Users/iejohnson/School/spring_2024/AML/Supervised_learning/DATA/ALL_PROSTATEx/WITH_SEGMENTATION")
    ...
    for subject_dir in prostatX_data.iterdir():
        ...
        if has_corresponding_segmentation:
            ...
            segmentation_output_file = image_output_dir/ f"{subject_dir.name}_Segmentation.nii.gz"
