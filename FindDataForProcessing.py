...
if __name__ == "__main__":
    ...
    default_output_dir = Path(
        "/Users/iejohnson/School/spring_2024/AML/Supervised_learning/DATA/ALL_PROSTATEx/WITHOUT_SEGMENTATION"
    )
    with_segmentation_output_dir = Path(
        "/Users/iejohnson/School/spring_2024/AML/Supervised_learning/DATA/ALL_PROSTATEx/WITH_SEGMENTATION"
    )
    ...
    for subject_dir in subject_dirs:
        ...
        if has_corresponding_segmentation:
            ...
            for image_name, image in best_images.items():
                ...
                # print(f"Image: {image}")
                output_file = (
                    image_output_dir / f"{subject_dir.name}_{image_name}.nii.gz"
                )
